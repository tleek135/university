...
int Filesys::readblock(string file, int blocknumber, string& buffer)
{
	int first = getfirstblock(file);
	if (first == -1) {
		cout << "readblock(): " << file << " does not exist.\n";
		return 0;
	}
	if (first == 0) {
		cout << "readblock(): " << file << " is empty.\n";
		return 0;
	}
	...
	while (fat[first] != 0 and fat[first] != blocknumber)
		first = fat[first];
	if (fat[first] == 0) {
		cout << "readblock(): Block number " << blocknumber << " is not in " << file << ".\n";
		return 0;
	}
...
int Filesys::writeblock(string file, int blocknumber, string buffer)
{
	int first = getfirstblock(file);
	if (first == -1) {
		cout << "writeblock(): " << file << " does not exist.\n";
		return 0;
	}
	if (first == 0) {
		cout << "writeblock(): " << file << " is empty.\n";
		return 0;
	}
	...
	while (fat[first] != 0 and fat[first] != blocknumber)
		first = fat[first];
	if (fat[first] == 0) {
		cout << "writeblock(): Block number " << blocknumber << " is not in " << file << ".\n";
		return 0;
	}
...
int Filesys::nextblock(string file, int blocknumber)
{
	int first = getfirstblock(file);
	if (first == -1) {
		cout << "nextblock(): " << file << " does not exist.\n";
		return -1;
	}
	if (first == -1) {
		cout << "nextblock(): " << file << " is empty.\n";
		return -1;
	}
	...
	while (fat[first] != 0 and fat[first] != blocknumber)
		first = fat[first];
	if (fat[first] == 0) {
		cout << "nextblock(): Block number " << blocknumber << " is not in " << file << ".\n";
		return -1;
	}
